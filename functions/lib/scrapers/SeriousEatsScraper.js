...
exports.SeriousEatsScraper = void 0;
const BaseScraper_1 = require("./BaseScraper");
class SeriousEatsScraper extends BaseScraper_1.BaseScraper {
    canHandle(hostname) {
    ...
    extractFromSelectors($) {
        try {
            ...
            const ingredientElements = $('.recipe-ingredient-group li, ' +
                '.ingredients li, ' +
            ...
            // Instructions
            const instructionElements = $('.recipe-procedures li, ' +
...
exports.SeriousEatsScraper = SeriousEatsScraper;
//# sourceMappingURL=SeriousEatsScraper.js.map