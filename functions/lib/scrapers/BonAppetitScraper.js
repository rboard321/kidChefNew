...
exports.BonAppetitScraper = void 0;
const BaseScraper_1 = require("./BaseScraper");
class BonAppetitScraper extends BaseScraper_1.BaseScraper {
    canHandle(hostname) {
    ...
    extractFromSelectors($) {
        try {
            ...
            const instructionElements = $('[data-testid="InstructionList"] li, ' +
            ...
            const prepTimeText = this.extractText($('[data-testid="prep-time"], ' +
                '.recipe-prep-time, ' +
                '.prep-time, ' +
                '.active-time, ' +
                '.recipe-time .prep').first());
            const cookTimeText = this.extractText($('[data-testid="cook-time"], ' +
                '.recipe-cook-time, ' +
                '.cook-time, ' +
                '.cooking-time, ' +
                '.recipe-time .cook').first());
            const totalTimeText = this.extractText($('[data-testid="total-time"], ' +
                '.recipe-total-time, ' +
                '.total-time, ' +
...
exports.BonAppetitScraper = BonAppetitScraper;
//# sourceMappingURL=BonAppetitScraper.js.map