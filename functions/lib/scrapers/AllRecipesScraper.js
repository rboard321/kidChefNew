...
exports.AllRecipesScraper = void 0;
const BaseScraper_1 = require("./BaseScraper");
const jsonLdNormalizer_1 = require("../services/jsonLdNormalizer");
class AllRecipesScraper extends BaseScraper_1.BaseScraper {
    canHandle(hostname) {
    ...
    extractFromSelectors($) {
        try {
            ...
            const imageElement = $('.recipe-image img, ' +
                '.image-container img, ' +
                '.hero-photo__image, ' +
            ...
            const ingredientElements = $('.recipe-ingred_txt, ' +
                '.ingredients li, ' +
            ...
            const instructionElements = $('.recipe-directions__list--item, ' +
                '.instructions li, ' +
                '.directions li, ' +
...
exports.AllRecipesScraper = AllRecipesScraper;
